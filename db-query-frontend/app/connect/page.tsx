        ...
        <div className="flex-1 bg-white relative flex flex-col h-full min-w-0 p-8 md:p-12">
            <div className="max-w-3xl w-full mx-auto flex flex-col justify-center h-full">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 border-b border-slate-100 pb-6">
                    <div>
                        <h2 className="text-3xl font-bold text-slate-900 mb-1 tracking-tight">Connect Database</h2>
                ...
                <div className="flex-1 flex flex-col justify-center">
                    ...
                    {provider && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                            
                            {/* SQL FORM (Supabase, Postgres, MySQL, Oracle) */}
                            {provider !== 'mongodb' && (
                                <>
                                    ...
                                    <div className="md:col-span-1">
                                        ...
                                        <input 
                                            type="number" 
                                            placeholder={provider === 'supabase' ? '6543' : provider === 'postgres' ? '5432' : provider === 'mysql' ? '3306' : '1521'} 
                                            className="input-field" 
                                    ...
                                    <div className="md:col-span-1">
                                        <label className="input-label">{provider === 'oracle' ? 'Service Name' : 'Database'}</label>
                                        <input 
                                    ...
                                    <div className="md:col-span-1">
                                        ...
                                        <input 
                                            placeholder={provider === 'supabase' ? 'postgres.project-ref' : 'postgres'} 
                                            className="input-field" 
